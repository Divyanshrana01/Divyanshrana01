...
<h3 align="center">🤖 Agentic AI & RAG Specialist · LangGraph · LangChain · CrewAI · LLMs | MSc AI @ Salford</h3>
...
|--------|-------------|-------|
| [MAX Agentic Chatbot](https://github.com/Divyanshrana01/MAX_Agentic_Chatbot) | Streaming multi-agent chatbot with real-time state management and tool use | LangGraph · Python · Streamlit |
| [Legal RAG Assistant](https://github.com/Divyanshrana01/QnA-chatbot) | Q&A with LangSmith observability and semantic retrieval | LangChain · FAISS · Streamlit |
| [DocTalk](https://github.com/Divyanshrana01) | Multi-source PDF & website chat with HuggingFace embeddings and Groq LLaMA 4 | LangChain · FAISS · HuggingFace |
| [Self-RAG Pipeline](https://github.com/Divyanshrana01/SELF_RAG) | LLM that dynamically retrieves, critiques, and generates using reflection tokens | LangGraph  
...
<p align="center">
  ...
  <img src="https://cdn.simpleicons.org/huggingface/FFD21E" height="50" width="60" alt="HuggingFace" />
